...
import { seedPlantSpeciesEntries, type PlantSpeciesSeed } from "./plant_species";

const plantSpeciesSeed: PlantSpeciesSeed[] = [
  {
  ...
  },
  {
    ...
    "common_name": "Kletterphilodendron",
    "moisture_critical": 20,
    "moisture_warning": 35,
    "temperature_min": 16,
    "temperature_max": 30,
  ...
  },
  {
    ...
    "name": "Phalaenopsis",
    "common_name": "Schmetterlingsorchidee",
    "moisture_critical": 20,
    "moisture_warning": 35,
    "temperature_min": 18,
    "temperature_max": 30,
  ...
  },
  {
    ...
    "common_name": "Stumpfblättrige Peperomie",
    "moisture_critical": 15,
    "moisture_warning": 30,
    "temperature_min": 15,
    "temperature_max": 30,
  ...
  },
  {
    ...
    "common_name": "Paradiesvogelblume",
    "moisture_critical": 20,
    "moisture_warning": 35,
    "temperature_min": 15,
    "temperature_max": 30,
  ...
  },
  {
    ...
    "name": "Dracaena trifasciata Laurentii",
    "common_name": "Gelb-Bogenhanf",
    "moisture_critical": 10,
    "moisture_warning": 20,
    "temperature_min": 15,
    "temperature_max": 35,
  ...
  },
  {
    ...
    "common_name": "Chinesisches Immergrün",
    "moisture_critical": 25,
    "moisture_warning": 40,
    "temperature_min": 16,
    "temperature_max": 30,
  ...
  },
  {
    ...
    "common_name": "Schirmpapyrus",
    "moisture_critical": 50,
    "moisture_warning": 65,
    "temperature_min": 15,
    "temperature_max": 28,
    "light_min": 300,
  ...
  },
  {
    ...
    "common_name": "Hasenpfoten-Marante",
    "moisture_critical": 35,
    "moisture_warning": 50,
    "temperature_min": 18,
    "temperature_max": 28,
  ...
  },
  {
    ...
    "common_name": "Samtblatt-Philodendron",
    "moisture_critical": 25,
    "moisture_warning": 40,
    "temperature_min": 18,
    "temperature_max": 30,
  ...
  {
    "id": "african-violet",
    "name": "Streptocarpus sect. Saintpaulia",
  ...
  {
    "id": "pothos-golden",
    "name": "Epipremnum aureum Golden",
    "common_name": "Goldene Efeutute",
    "moisture_critical": 15,
    "moisture_warning": 30,
    "temperature_min": 15,
    "temperature_max": 30,
  ...
  },
  {
    ...
    "common_name": "Adanson-Fensterblatt",
    "moisture_critical": 20,
    "moisture_warning": 35,
    "temperature_min": 16,
    "temperature_max": 30,
  ...
  },
  {
    ...
    "common_name": "Pfeilblatt-Syngonium",
    "moisture_critical": 25,
    "moisture_warning": 40,
    "temperature_min": 16,
    "temperature_max": 30,
  ...
  },
  {
    ...
    "common_name": "Lippenstiftpflanze",
    "moisture_critical": 25,
    "moisture_warning": 40,
    "temperature_min": 18,
    "temperature_max": 28,
  ...
  },
  {
    ...
    "name": "Goeppertia insignis",
    "common_name": "Lanzett-Korbmarante",
    "moisture_critical": 35,
    "moisture_warning": 50,
    "temperature_min": 18,
    "temperature_max": 28,
  ...
  },
  {
    ...
    "common_name": "Burgunder-Gummibaum",
    "moisture_critical": 25,
    "moisture_warning": 40,
    "temperature_min": 15,
    "temperature_max": 30,
  ...
  },
  {
    ...
    "common_name": "Purpur-Dreimasterblume",
    "moisture_critical": 20,
    "moisture_warning": 35,
    "temperature_min": 12,
    "temperature_max": 28,
  ...
  },
  {
    ...
    "common_name": "Chinesische Geldpflanze",
    "moisture_critical": 20,
    "moisture_warning": 35,
    "temperature_min": 13,
    "temperature_max": 28,
  ...
  {
    "id": "lemon-cypress",
    "name": "Cupressus macrocarpa Goldcrest",
    "common_name": "Zitronenthuje",
    "moisture_critical": 25,
    "moisture_warning": 40,
    "temperature_min": 5,
    "temperature_max": 22,
  ...
  {
    "id": "peace-lily-mauna-loa",
    "name": "Spathiphyllum Mauna Loa",
    "common_name": "Großes Einblatt",
    "moisture_critical": 30,
    "moisture_warning": 45,
    "temperature_min": 16,
    "temperature_max": 28,
  ...
  {
    "id": "succulent-echeveria-mix",
    "name": "Echeveria hybrid",
    "common_name": "Echeveria-Hybride",
    "moisture_critical": 8,
    "moisture_warning": 15,
    "temperature_min": 10,
    "temperature_max": 35,
  ...
  },
  {
    ...
    "common_name": "Xanadu Philodendron",
    "moisture_critical": 20,
    "moisture_warning": 35,
    "temperature_min": 16,
    "temperature_max": 30,
  ...
  {
    "id": "calathea-zebrina",
    "name": "Goeppertia zebrina",
    "common_name": "Zebra-Korbmarante",
    "moisture_critical": 35,
    "moisture_warning": 50,
    "temperature_min": 18,
    "temperature_max": 28,
...
export const seedPlants = mutation({
  ...
  handler: async (ctx: MutationCtx) => {
    return await seedPlantSpeciesEntries(ctx, plantSpeciesSeed);
  },
});
