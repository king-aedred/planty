...
function isDbQueryChainFallback(expr) {
    ...
    if (methodName === "query") {
        ...
        // `ctx.db.query(...)`
        if (baseObject.type === AST_NODE_TYPES.MemberExpression &&
        ...
        if (baseObject.type === AST_NODE_TYPES.Identifier &&
            baseObject.name === "db") {
            return true;
        }
        ...
        if (baseObject.type === AST_NODE_TYPES.MemberExpression &&
            ...
            if (innerObject.type === AST_NODE_TYPES.Identifier &&
                innerObject.name === "db") {
                return true;
            }
            if (innerObject.type === AST_NODE_TYPES.MemberExpression &&
...
export const noFilterInQuery = createRule({
    ...
    create: (context) => {
        ...
        function isIdentifierExplicitAnyType(id) {
            return (id.typeAnnotation?.typeAnnotation.type === AST_NODE_TYPES.TSAnyKeyword);
        }
